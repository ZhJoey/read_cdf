...
OUT_NAME = f"rbsp_6panel_mageis_rept_{START_DATE}_{END_DATE}_corrected_2.png"
...
if __name__ == "__main__":
    ...
    ax = axes[3]
    pm = ax.pcolormesh(x_rept, rept_A, rept_log_tp.T, shading="nearest", cmap="jet",
    ...
    ax.text(ENERGY_LABEL_X, 0.5, f"{E_REPT_TP:g} MeV", transform=ax.transAxes,
             rotation=90, va="center", ha="right", fontsize=FS_LABEL)

    # Panel 5: Dst & Kp (x_hours)
    ax5 = axes[4]
